        ...
        <div className="collapse navbar-collapse flex-row-reverse d-none d-lg-flex">
          <ul className="navbar-nav me-5">
            <li className="nav-item me-3">
              <NavLink to="/inicioAdmin" className="nav-link">
            ...
            <li className="nav-item me-3">
              <NavLink to="/reportes" className="nav-link">
                <i className="fi fi-rr-chart-histogram me-2"></i>Reportes
              </NavLink>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#!">
                <i className="fi fi-rr-settings me-2"></i>Ajustes
              </a>
            </li>
          </ul>
        </div>
          ...
          <div className="offcanvas-body">
            <ul className="navbar-nav flex-column">
              <li className="nav-item mb-3">
                <NavLink to="/inicioAdmin" className="nav-link" onClick={closeMenu}>
                  <i className="fi fi-rr-home me-2"></i>Inicio
                </NavLink>
              </li>
              <li className="nav-item mb-3">
              ...
              <li className="nav-item mb-3">
                <NavLink to="/reportes" className="nav-link" onClick={closeMenu}>
                  <i className="fi fi-rr-chart-histogram me-2"></i>Reportes
                </NavLink>
              </li>
              <li className="nav-item">
