          ...
          <div className="card-parqueo">
            ...
            <div className="mb-4 p-3" style={{ background: "#1f4e79", borderRadius: 10, color: "white" }}>
              ...
              <div className="d-flex justify-content-around flex-wrap gap-3">
                ...
                <div className="text-center">
                  <div style={{ fontSize: 28, fontWeight: 900, color: totalEspacios >= 800 ? "#cb3634" : "#22c55e" }}>
                    {800 - totalEspacios}
                  </div>
                  <small>Espacios disponibles para agregar</small>
                </div>
              </div>
            ...
            <div className="text-center mb-4">
              <button
                ...
                style={{
                  background: totalEspacios >= 800 ? "#aaa" : "#1f4e79",
                  color: "white", border: "none", borderRadius: 8,
                  padding: "10px 24px", fontWeight: 700,
                  cursor: totalEspacios >= 800 ? "not-allowed" : "pointer",
                  fontSize: 15
                }}
              >
                ...
                <div className="d-flex flex-wrap gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e => setNuevaIsla({ ...nuevaIsla, carros: e.target.value })}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e => setNuevaIsla({ ...nuevaIsla, discapacitados: e.target.value })}
                      style={{ display: "block", padding: "6px 10px", borderRadius: 6, border: "1px solid #ccc", width: 100 }}
                    />
                  </div>
                </div>
            ...
            {/* ISLAS */}
            {islas.length === 0 ? (
              <div className="text-center p-5" style={{ color: "#aaa" }}>
                <div style={{ fontSize: 48 }}>🏝</div>
                <p>No hay islas creadas aún. Crea una nueva isla para comenzar.</p>
              </div>
            ) : (
                ...
                {islas.map((isla) => (
                  <div key={isla.id} className="card-isla p-4 shadow-sm w-100">
                    <div className="d-flex justify-content-between align-items-center mb-1">
                      <h5 className="mb-0">{isla.nombre}</h5>
                      <button
